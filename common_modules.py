...
# Count the number of occurrences for each nucleotide and return
# a dictionary containing the nucleotide as a key and the occurrences
# as the item
def count_nucleotides(string_1):
    nucleotide_counter = defaultdict(int)
    for nucleotide in string_1:
...
if __name__ == '__main__':
    ...
    print(count_nucleotides(string))
